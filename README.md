...
aweswitch apply --opencode --prune-providers          # also remove every provider no profile backs (hand-written included)
aweswitch apply --opencode --prune-providers old-a,old-b --dry-run  # preview named removals, write nothing
